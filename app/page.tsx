...
const testimonials = [
  {
    ...
    content: "LinkLoom transformed how I share my content. The analytics help me understand what my audience loves most!",
    rating: 5
  },
  {
    name: "Mike Chen",
    role: "Small Business Owner",
    content: "Perfect for my business. Clean, professional, and my customers can easily find all my important links.",
    rating: 5
  },
  {
    name: "Emma Davis",
    role: "Artist",
    content: "The customization options are amazing. My link page perfectly matches my artistic brand and style.",
    rating: 5
  }
]
    ...
    <div className="min-h-screen bg-gradient-to-r from-gray-50 to-gray-100">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Create a beautiful, customizable link-in-bio page that showcases all your important links. Perfect for creators, businesses, and anyone who wants to share mulitple links effortlessly.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
              <Button asChild size="lg" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-lg px-8 py-6 h-auto">
              ...
              <Button asChild variant="outline" size="lg" className="border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white text-lg px-8 py-6 h-auto">
            ...
            <div className="pt-12">
              ...
              <div className="flex justify-center itmes-center gap-8 opacity-60">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <p className="text-gray-600 loading-relaxed">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See what out users are saying about LinkLoom
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl p-8 shadow-xl shadow-gray-200/50">
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 fill-yellow-400 text-yellow-400" />
                  ))}
                </div>
                <p className="text-gray-600 mb-6 leadgin-relaxed">
      ...
      <section className="px-4 lg:px-8 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-12 lg:p-16 text-white shadow-2xl">
            <h2 className="etxt-4xl lg:text-5xl font-bold mb-6">
              Ready to Get Started?
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Join thousands of creators who trust LinkLoom to showcase their content. Create your beautiful link page in minutes, not hours.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button asChild size="lg" className="bg-white text-purple-600 hover:bg-gray-100 text-lg px-8 py-6 h-auto font-semibold">
                <Link href="/dashboard" className="flex items-center gap-2">
                  Create Your LinkLoom
                  <ArrowRight className="w-5 h-5" />
                </Link>
              </Button>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="text-2xl font-bold text-gray-900">LinkLoom</div>
